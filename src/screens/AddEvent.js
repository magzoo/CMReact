        ...
        return(
            <View>
              ...
              <View>
                    ...
                    <TextInput style={styles.textInput} placeholder="Insira o nome do evento" onChangeText={(value) => {setEventName(value)}} ></TextInput>
                  </View>
                  <View>
                    <Text style={styles.textInputTitle}>Descrição do evento:</Text>
                    <TextInput style={styles.textInput} placeholder="Insira a descrição do evento" onChangeText={(value) => {setDescription(value)}}></TextInput>
                  </View>
                ...
                <View>
                  <View style={styles.moradaMargin}>
                    ...
                    <TextInput style={styles.textInput} placeholder="Insira a localização do evento" onChangeText={(value) => onChangeAddress(value)}></TextInput>
                </View>
                <View style={styles.timeButtonContainer}>
